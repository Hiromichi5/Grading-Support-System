...
if __name__ == "__main__":
    ...
    X_train_maru, X_test_maru, y_train_maru, y_test_maru = train_test_split(data_maru, np.array(label_maru), test_size=0, random_state=42)
    X_train_batu, X_test_batu, y_train_batu, y_test_batu = train_test_split(data_batu, np.array(label_batu), test_size=0, random_state=42)
    # 異常検出
